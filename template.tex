...
\begin{table}
\centering
\caption{Duration values}
\label{duration}
\subcaption{Northern Hemisphere}
\begin{tabular}{|l|l|l|l|l|}
\hline
 Season & Method & NC    & NP    & NA   \\ \hline
\multirow{3}{*}{JJA} 
   & $AGP$  & 6.75 to 10.75  & 7.25 to 20.50  & 7.25 to 18.00  \\ 
   & $Z^*$   & 6.50 to 9.94 & 7.25 to 12.56 & 6.75 to 11.75\\  
   & $PV^*$  & 6.12 to 7.50 & 6.5 to 9.38 & 6.25 to 8.75 \\ 
   \hline
\multirow{3}{*}{DJF}
...
\hline
 Season & Method & NC    & NP    & NA   \\ \hline
\multirow{3}{*}{JJA} 
   & $AGP$  & 6.12 to 7.5  & 6.5 to 9.38 & 6.25 to 8.75  \\ 
   & $Z^*$   & 6.50 to 9.94 & 7.25 to 12.56 & 6.75 to 11.75\\  
   & $PV^*$  & 6.75 to 10.75 & 7.25 to 20.50 & 7.25 to 18.00 \\ 
   \hline
\multirow{3}{*}{DJF}
  & $PV^*$ and $AGP$ & 0.62** & \textit{0.01} &\textit{ -0.06*} \\  
  & $Z^*$ and $AGP$  & \textit{0.26**}& \textit{-0.04+}& \textit{-0.01}  \\ 
...
\multirow{8}{*}{JJA} 
   & \multirow{2}{*}{$PV^* $ and $AGP$}&$P(PV^*|AGP)$ & \textit{0.07} & \textit{0.08} & \textit{{0.09}}  \\  
   & & $P(AGP|PV^*)$ & {0.42} & {0.41} & {0.33}  \\ 
   &&&&&\\
   & \multirow{2}{*}{$Z^*$ and $AGP$} &$P(Z^*|AGP)$    & \textit{{0.23}} & \textit{{0.30}} & \textit{{0.30} } \\  
   &&$P(AGP|Z^*)$   & {0.39} & {0.56} & {0.39} \\ 
      &&&&&\\
  ...
  \hline
  \multirow{8}{*}{DJF} 
   & \multirow{2}{*}{$PV^* $ and $AGP$}&$P(PV^*|AGP)$ & {0.40} & {0.45} &\textit{{0.30}}  \\
   & & $P(AGP|PV^*)$& \textit{{0.29}} &\textit{0.30}& {0.45}\\ 
      &&&&&\\
   & \multirow{2}{*}{$Z^*$ and $AGP$} &$P(Z^*|AGP)$ & {0.67} &0.56& {0.65} \\ 
   &&$P(AGP|Z^*)$   & \textit{{0.18} }& \textit{0.23} & 0.38 \\ 
      &&&&&\\
...
\hline
  ...
  \hline
  \multirow{8}{*}{DJF} 
   & \multirow{2}{*}{$PV^* $ and $AGP$}&$P(PV^*|AGP)$ & \textit{{0.12}} & \textit{{0.17} }& \textit{{0.17}} \\
   & & $P(AGP|PV^*)$ & \textit{{0.02}} & \textit{0.11}& \textit{{0.01}} \\ 
      &&&&&\\
   & \multirow{2}{*}{$Z^*$ and $AGP$} &$P(Z^*|AGP)$  & \textbf{0.76} & \textbf{{0.73}} & \textbf{1.00} \\ 
   &&$P(AGP|Z^*)$  & \textit{{0.05} }& \textit{{0.20} }& \textit{{0.01} }\\ 
      &&&&&\\
      & \multirow{2}{*}{$PV^*$ and $Z^*$ } &$P(PV^*|Z^*)$    & {0.38} & {0.32} & {0.32} \\
   &&$P(Z^*|PV^*)$   &\textbf{0.80} & \textbf{0.78} & \textbf{0.80} \\   
   \hline
\multirow{8}{*}{JJA} 
   & \multirow{2}{*}{$PV^* $ and $AGP$}&$P(PV^*|AGP)$ & {0.49} & 0.26 & {0.65} \\  
   & & $P(AGP|PV^*)$  &\textit{{0.03}} & \textit{{0.17}} & \textit{{0.06}} \\ 
   &&&&&\\
   & \multirow{2}{*}{$Z^*$ and $AGP$} &$P(Z^*|AGP)$  & \textbf{0.98} & {0.66} & \textbf{0.79} \\  
   &&$P(AGP|Z^*)$    & \textit{{0.02}} & \textit{{0.18}} & \textit{{0.03}} \\ 
      &&&&&\\
