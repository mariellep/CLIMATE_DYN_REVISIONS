...
\begin{figure}
    ...
    \caption{Boxplots of block duration values, in days. The brackets indicate pairs with significant statistical differences in the median values, with a ``*'' denoting $0.01<p<0.05$ and a ``**'' denoting $p<<0.01$}
    \label{duration}
\end{figure}
...
\begin{figure}
    ...
    \caption{Distributions of zonal distance}
    \label{dist}
\end{figure}
